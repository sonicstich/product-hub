...
// database_id parent under the old API is rejected).
const BUG_BOARD_DS_ID      = () => process.env.BUG_BOARD_DS_ID || '6a193143-2c58-4fb4-a17f-0105d466ab38';
...
async function createBugTask(inc) {
  ...
  const payload = {
    parent: { type: 'data_source_id', data_source_id: BUG_BOARD_DS_ID() },
    properties: props,
