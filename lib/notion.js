...
// Slack user id → Notion user id, so we can co-assign the reporter on the task
// (their Slack id comes from sign-in; Notion needs its own user id). Override
// with the SLACK_TO_NOTION env (JSON); the default covers the current team.
const SLACK_TO_NOTION_DEFAULT = {
  U09NZ2BDSAY: '299d872b-594c-8131-bef4-0002816b3e50', // Emil Mubarakov
  U0780P502VA: 'ea242ffb-0eb2-4e54-bd1c-eaff5c4aa3b5', // Yuriy Kuchanov
  U077HN3FBK9: 'c60f031d-305d-46a1-be0e-dd018d173e32', // Sergey Andreev
  U0780P3V5S8: '464f594e-e0dd-4498-af02-ce7f9e2f474f', // Sergei Grabovoi
  U0937P7EETZ: '222d872b-594c-8119-a394-000290cd3ff1', // Nikola Yankov
  U077Y92TGHG: '777ee4d2-4139-4a85-9114-e4d863ee2ad2', // Maksim Lamanskiy
  U077RKZ50DC: '4bac3dda-9571-40fd-9d64-03ce0a4a3866', // Kirill Demchenko
  U077Y95J82E: '4764cc4f-7c10-4b9b-8e48-61e479c25e34', // Ilia Pogudin
  U0BJ1783LCS: '3a0d872b-594c-8147-949d-0002623048ab', // Svilen Strahilov
};
function reporterNotionId(slackId) {
  if (!slackId) return null;
  let map = SLACK_TO_NOTION_DEFAULT;
  try { const e = JSON.parse(process.env.SLACK_TO_NOTION || 'null'); if (e && typeof e === 'object') map = e; } catch (_) {}
  return map[slackId] || null;
}
...
async function createBugTask(inc, opts = {}) {
  ...
  // Assignee: the picked dev (or the area map) PLUS the reporter, so whoever
  // filed the incident is always on the task too. Guard id shapes; dedupe.
  ...
  const reporterNotion = reporterNotionId(opts.reporterId);
  if (reporterNotion) people.add(reporterNotion);
