...
async function dmTaskCreated(userId, taskUrl, title) {
  ...
  const blocks = [
    { type: 'section', text: { type: 'mrkdwn', text: `✅ Your task has been created:\n*<${taskUrl}|${t}>*` } },
    { type: 'context', elements: [{ type: 'mrkdwn', text: 'Follow its status and the latest details in Notion.' }] },
  ];
